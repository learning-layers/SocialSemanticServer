...
public class SSAccessRightsUserEntitiesToCircleAddTest extends SSServOpTestCaseA{
  
  public SSAccessRightsUserEntitiesToCircleAddTest(SSAccessRightsConf accessRightsConf){
    super(accessRightsConf, SSMethU.accessRightsUserEntitiesToCircleAdd);
  }
  ...
  protected void test() throws Exception {
    ...
    final Boolean        result      = SSServCaller.accessRightsUserEntitiesToCircleAdd(userUri, userCircles.get(0).circleUri, entityUris, true);
