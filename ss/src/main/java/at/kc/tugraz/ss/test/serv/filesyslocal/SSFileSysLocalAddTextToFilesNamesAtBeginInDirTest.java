...
public class SSFileSysLocalAddTextToFilesNamesAtBeginInDirTest extends SSServOpTestCaseA{

  public SSFileSysLocalAddTextToFilesNamesAtBeginInDirTest(SSFileSysLocalConf conf) throws Exception{
    super(conf, SSMethU.fileSysLocalAddTextToFilesNamesAtBeginInDir);
  }
