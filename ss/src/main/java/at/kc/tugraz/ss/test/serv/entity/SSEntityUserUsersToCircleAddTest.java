...
public class SSEntityUserUsersToCircleAddTest extends SSServOpTestCaseA{
  
  public SSEntityUserUsersToCircleAddTest(SSEntityConf entityConf){
    super(entityConf, SSMethU.entityUserUsersToCircleAdd);
  }
  ...
  protected void test() throws Exception {
    ...
    final SSUri          circleUri   = SSServCaller.entityUserUsersToCircleAdd(userUri, userCircles.get(0).circleUri, userUris, true);
