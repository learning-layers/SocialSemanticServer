...
public class SSRecommTagsBaseLevelLearningWithContextBasedOnUserEntityTagTimestampTest extends SSServOpTestCaseA{
  
  public SSRecommTagsBaseLevelLearningWithContextBasedOnUserEntityTagTimestampTest(final SSRecommConf recommConf) {
    super(recommConf, SSMethU.recommTagsBaseLevelLearningWithContextBasedOnUserEntityTagTimestamp);
  }
