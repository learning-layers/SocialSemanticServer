...
*/
package at.kc.tugraz.ss.test.disc;
...
public class SSDiscUserShareWithUserTest extends SSServOpTestCaseA{
  
  public SSDiscUserShareWithUserTest(final SSDiscConf discConf) {
    super(discConf, SSMethU.discUserShareWithUser);
  }
