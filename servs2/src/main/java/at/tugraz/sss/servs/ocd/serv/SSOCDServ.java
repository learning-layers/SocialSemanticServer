 ...
 */
package at.tugraz.sss.servs.ocd.serv;
...
public class SSOCDServ extends SSServContainerI{
  
  public static final SSOCDServ inst = new SSOCDServ(SSOCDClientI.class, SSOCDServerI.class);
