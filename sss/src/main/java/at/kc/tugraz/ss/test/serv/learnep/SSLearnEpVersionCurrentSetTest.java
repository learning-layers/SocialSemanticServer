...
public class SSLearnEpVersionCurrentSetTest extends SSServOpTestCaseA{
  
  public SSLearnEpVersionCurrentSetTest(final SSLearnEpConf learnEpConf) {
    super(learnEpConf, null, SSServOpE.learnEpVersionCurrentSet);
  }
