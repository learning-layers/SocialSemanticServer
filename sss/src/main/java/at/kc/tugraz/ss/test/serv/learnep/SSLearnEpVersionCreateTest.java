...
public class SSLearnEpVersionCreateTest extends SSServOpTestCaseA{
  
  public SSLearnEpVersionCreateTest(final SSLearnEpConf learnEpConf) {
    super(learnEpConf, null, SSServOpE.learnEpVersionCreate);
  }
