...
public class SSSearchCombinedRet extends SSServRetI{
  
  public List<SSSearchResult> searchResults = new ArrayList<SSSearchResult>();
  
  public static SSSearchCombinedRet get(
    final List<SSSearchResult> searchResults,
    final SSMethU              op){
    
    return new SSSearchCombinedRet(searchResults, op);
  }
  
  private SSSearchCombinedRet(
    final List<SSSearchResult> searchResults,
    final SSMethU              op){
