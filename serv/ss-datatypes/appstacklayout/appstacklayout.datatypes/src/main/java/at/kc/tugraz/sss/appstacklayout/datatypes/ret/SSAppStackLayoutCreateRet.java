...
public class SSAppStackLayoutCreateRet extends SSServRetI{
  ...
  public SSUri appStackLayout = null;
  
  public static SSAppStackLayoutCreateRet get(
    final SSUri    appStackLayout,
    final SSMethU  op){
    
    return new SSAppStackLayoutCreateRet(appStackLayout, op);
  }
  ...
  public Map<String, Object> jsonLDDesc(){
    ...
    ld.put(SSVarU.appStackLayout, SSVarU.sss + SSStrU.colon + SSUri.class.getName());
  ...
  public String getAppStackLayout() {
    return SSStrU.removeTrailingSlash(appStackLayout);
  }
}
