...
## How-to-use
Please have a look at the Learning Layers Open Developer Library at http://developer.learning-layers.eu/documentation/social-semantic-server/ for set up and REST API access.
