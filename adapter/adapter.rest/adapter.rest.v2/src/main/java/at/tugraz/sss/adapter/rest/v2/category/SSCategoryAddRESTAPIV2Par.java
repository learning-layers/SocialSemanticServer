...
@XmlRootElement
@ApiModel(value = "category add request parameter")
public class SSCategoryAddRESTAPIV2Par{
  
  @ApiModelProperty(
    required = true,
    value = "label for the category")
  ...
  @ApiModelProperty(
    required = true,
    value = "circle, if space is circleSpace; restricts the category to be visible to users in circle")
  ...
  public SSCategoryAddRESTAPIV2Par(){}
}
