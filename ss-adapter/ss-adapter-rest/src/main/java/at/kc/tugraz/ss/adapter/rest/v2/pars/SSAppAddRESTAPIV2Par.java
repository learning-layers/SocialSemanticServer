...
public class SSAppAddRESTAPIV2Par{
  ...
  public void setDownloads(final List<String> downloads) throws Exception{
    try{ this.downloads = SSUri.get(downloads, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
  ...
  public void setDownloadIOS(final String downloadIOS) throws Exception{
    try{ this.downloadIOS = SSUri.get(downloadIOS, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
  ...
  public void setDownloadAndroid(final String downloadAndroid) throws Exception{
    try{ this.downloadAndroid = SSUri.get(downloadAndroid, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  } 
  ...
  public void setFork(final String fork) throws Exception{
    try{ this.fork = SSUri.get(fork, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
  ...
  public void setScreenShots(final List<String> screenShots) throws Exception{
    try{ this.screenShots = SSUri.get(screenShots, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
  ...
  public void setVideos(final List<String> videos) throws Exception{
    try{ this.videos = SSUri.get(videos, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
