...
public class SSVideoAddRESTAPIV2Par{
  ...
  public void setLink(final String link) throws Exception{
    try{ this.link = SSUri.get(link, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
  ...
  public void setForEntity(final String forEntity) throws Exception{
    try{ this.forEntity = SSUri.get(forEntity, SSRestMain.conf.vocConf.uriPrefix); }catch(Exception error){}
  }
