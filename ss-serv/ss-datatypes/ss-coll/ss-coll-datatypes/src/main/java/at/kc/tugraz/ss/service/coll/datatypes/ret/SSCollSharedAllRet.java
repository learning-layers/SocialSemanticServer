...
public class SSCollSharedAllRet extends SSServRetI{

  public List<SSColl> colls = new ArrayList<SSColl>();

  public static SSCollSharedAllRet get(List<SSColl> colls, SSMethU op){
    return new SSCollSharedAllRet(colls, op);
  }
  
  private SSCollSharedAllRet(List<SSColl> colls, SSMethU op) {
