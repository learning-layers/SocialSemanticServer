...
public class SSDataExportUserResourceTimestampTagsCategoriesPar extends SSServPar{
  ...
  public SSDataExportUserResourceTimestampTagsCategoriesPar(final SSServPar par) throws Exception{
