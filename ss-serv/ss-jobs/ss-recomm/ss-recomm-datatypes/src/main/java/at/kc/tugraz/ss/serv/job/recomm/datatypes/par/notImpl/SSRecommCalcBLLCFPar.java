 ...
 */
package at.kc.tugraz.ss.serv.job.recomm.datatypes.par.notImpl;

import at.kc.tugraz.socialserver.utils.SSVarU;
import at.kc.tugraz.ss.serv.datatypes.SSServPar;
import at.kc.tugraz.ss.serv.err.reg.SSServErrReg;

public class SSRecommCalcBLLCFPar extends SSServPar{

  public String  sampleDir   = null;
  public String  sampleName  = null;
  public Integer sampleCount = null;
  public Integer neighbors   = null;
  public Integer dVal        = null;
    
  public SSRecommCalcBLLCFPar(SSServPar par) throws Exception{
    ...
    try{
      if(pars != null){
        ...
        this.neighbors   = (Integer) pars.get (SSVarU.neighbors);
        this.dVal        = (Integer) pars.get (SSVarU.dVal);
      }
      ...
      if(clientPars != null){
        ...
        this.neighbors   = Integer.valueOf (clientPars.get (SSVarU.neighbors));
        this.dVal        = Integer.valueOf (clientPars.get (SSVarU.dVal));
      }
