...
public class SSRecommCalcActPar extends SSServPar{
  ...
  public SSRecommCalcActPar(SSServPar par) throws Exception{
    ...
    try{
      if(pars != null){
        ...
        this.dUpperBound    = (Integer) pars.get(SSVarU.dUpperBound);
      ...
      if(clientPars != null){
        ...
        this.dUpperBound    = Integer.valueOf(clientPars.get(SSVarU.dUpperBound));
