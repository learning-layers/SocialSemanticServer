...
public class SSCircle extends SSEntityA{
  ...
  public List<SSAccessRightsRightTypeE> circleRights = new ArrayList<SSAccessRightsRightTypeE>();
  ...
  public static SSCircle get(
    ...
    final List<SSAccessRightsRightTypeE> circleRights,
  ...
  public Object jsonLDDesc(){
    ...
    ld.put(SSVarU.circleType, SSVarU.sss + SSStrU.colon + SSAccessRightsCircleTypeE.class.getName());
    
    circleRightsObj.put(SSJSONLDU.id,        SSVarU.sss + SSStrU.colon + SSAccessRightsRightTypeE.class.getName());
