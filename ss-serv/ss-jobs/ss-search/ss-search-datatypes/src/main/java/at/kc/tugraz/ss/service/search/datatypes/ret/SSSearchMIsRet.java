...
public class SSSearchMIsRet extends SSServRetI{

  public List<SSSearchResult> searchResults = new ArrayList<SSSearchResult>();

  public static SSSearchMIsRet get(List<SSSearchResult> searchResults, SSMethU op){
    return new SSSearchMIsRet(searchResults, op);
  }
  
  private SSSearchMIsRet(List<SSSearchResult> searchResults, SSMethU op){
