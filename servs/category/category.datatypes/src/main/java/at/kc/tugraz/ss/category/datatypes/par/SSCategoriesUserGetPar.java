...
@XmlRootElement
@ApiModel(value = "categoriesUserGet request parameter")
public class SSCategoriesUserGetPar extends SSServPar{
  
  @ApiModelProperty(
    required = false, 
    value = "user to retrieve category assignments for (optional)")
  ...
  @ApiModelProperty(
    required = false, 
    value = "entities to retrieve category assignments for (optional)")
  ...
  @ApiModelProperty(
    required = false, 
    value = "category labels to consider for retrieving category assignments (optional)")
  ...
  @ApiModelProperty(
    required = false, 
    value = "access restriction for to be retrieved category assignments (i.e. privateSpace, sharedSpace) (optional)")
  public SSSpaceE           space          = null;
  
  @XmlElement
  @ApiModelProperty(
    required = false, 
    value = "timestamp to retrieve category assignments from a certain point in time (optional)")
  public Long               startTime      = null;
  
  public SSCategoriesUserGetPar(){}
    
  public SSCategoriesUserGetPar(SSServPar par) throws Exception{
