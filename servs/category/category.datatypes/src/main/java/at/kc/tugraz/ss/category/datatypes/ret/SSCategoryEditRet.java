...
public class SSCategoryEditRet extends SSServRetI{
  ...
  public static SSCategoryEditRet get(
    final SSUri   category){
    
    return new SSCategoryEditRet(category);
  }
  
  private SSCategoryEditRet(
    final SSUri   category){
    
    super(SSServOpE.categoryEdit);
