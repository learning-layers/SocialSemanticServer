...
public enum SSMailSendE implements SSJSONLDPropI{
  ...
  public static SSMailSendE get(final String mailSend) throws Exception{
    ...
    try{
      ...
      throw new Exception("mail send enum invalid");
    }
  }
  
  public static List<SSMailSendE> get(final List<String> strings) throws Exception{
