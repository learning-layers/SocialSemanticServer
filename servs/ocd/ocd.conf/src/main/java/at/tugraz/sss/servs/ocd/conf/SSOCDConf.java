 ...
 * the License.
 */
package at.tugraz.sss.servs.ocd.conf;

import at.tugraz.sss.serv.SSCoreServConfA;
import at.tugraz.sss.serv.SSServConfA;

public class SSOCDConf extends SSCoreServConfA {

    public static SSOCDConf copy(final SSOCDConf orig) {

        final SSOCDConf copy = (SSOCDConf) SSServConfA.copy(orig, new SSOCDConf());
