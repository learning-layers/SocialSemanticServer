...
public interface SSOCDServerI {
  ...
  public String             ocdCreateGraph              (final SSOCDCreateGraphPar parA) throws Exception;
  public String             ocdGetGraphs                (final SSOCDGetGraphsPar parA) throws Exception;
  public String             ocdGetGraph                 (final SSOCDGetGraphPar parA) throws Exception;
  public String             ocdDeleteGraph              (final SSOCDDeleteGraphPar parA) throws Exception;
  public String             ocdCreateCover              (final SSOCDCreateCoverPar parA) throws Exception;
  public String             ocdGetCovers                (final SSOCDGetCoversPar parA) throws Exception;
  public String             ocdDeleteCover              (final SSOCDDeleteCoverPar parA) throws Exception;
