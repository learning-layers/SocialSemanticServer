...
public interface SSOCDServerI {
    public String ocdCreateGraph   (final SSServPar parA) throws Exception;
    ...
    public String ocdCreateCover  (final SSServPar parA) throws Exception;
    public String ocdGetCovers    (final SSServPar parA) throws Exception;
    public String ocdDeleteCover  (final SSServPar parA) throws Exception;
