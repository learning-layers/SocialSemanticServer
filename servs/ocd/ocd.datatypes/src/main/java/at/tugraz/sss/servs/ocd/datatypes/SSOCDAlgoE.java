 ...
 * the License.
 */
package at.tugraz.sss.servs.ocd.datatypes;


public enum SSOCDAlgoE {
    RANDOM_WALK_LABEL_PROPAGATION_ALGORITHM, 
    SPEAKER_LISTENER_LABEL_PROPAGATION_ALGORITHM, 
    EXTENDED_SPEAKER_LISTENER_LABEL_PROPAGATION_ALGORITHM, 
    SSK_ALGORITHM, 
    LINK_COMMUNITIES_ALGORITHM, 
    WEIGHTED_LINK_COMMUNITIES_ALGORITHM, 
    CLIZZ_ALGORITHM, 
    MERGING_OF_OVERLAPPING_COMMUNITIES_ALGORITHM,
    BINARY_SEARCH_RANDOM_WALK_LABEL_PROPAGATION_ALGORITHM;
    
    public static SSOCDAlgoE get (final String algorithm) {
        
        return SSOCDAlgoE.valueOf(algorithm);
    }
