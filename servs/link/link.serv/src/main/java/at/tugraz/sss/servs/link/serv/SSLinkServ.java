  ...
  */
package at.tugraz.sss.servs.link.serv;
...
public class SSLinkServ extends SSServContainerI{
  
  public static final SSLinkServ inst = new SSLinkServ(SSLinkClientI.class, SSLinkServerI.class);
  
  protected SSLinkServ(
