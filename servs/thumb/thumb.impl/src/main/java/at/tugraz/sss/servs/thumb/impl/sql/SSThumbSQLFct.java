...
*/
package at.tugraz.sss.servs.thumb.impl.sql;
...
public class SSThumbSQLFct extends SSDBSQLFct{
  
  public SSThumbSQLFct(SSServImplWithDBA serv) throws Exception{
    super(serv.dbSQL);
  }
  ...
  public void removeThumbs(final SSUri entity) throws Exception{
    ...
    try{
      ...
      dbSQL.deleteIgnore(SSSQLVarNames.thumbnailsTable, deletes);
    }catch(Exception error){
      SSServErrReg.regErrThrow(error);
    }
  }
