...
public class SSDiscEntryUpdateRet extends SSServRetI{
  ...
  public static SSDiscEntryUpdateRet get(
    final SSUri   disc, 
    final SSUri   discEntry){
    
    return new SSDiscEntryUpdateRet(disc, discEntry);
  }
  
  private SSDiscEntryUpdateRet(
    final SSUri     disc, 
    final SSUri     discEntry){
    
    super(SSVarNames.discEntryUpdate);
