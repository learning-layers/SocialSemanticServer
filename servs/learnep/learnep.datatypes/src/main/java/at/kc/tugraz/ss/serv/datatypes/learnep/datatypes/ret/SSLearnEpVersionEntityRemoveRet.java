...
public class SSLearnEpVersionEntityRemoveRet extends SSServRetI{
  ...
  private SSLearnEpVersionEntityRemoveRet(Boolean worked){
    
    super(SSVarNames.learnEpVersionEntityRemove);
